#!/bin/bash
#######################################################
# BreakBuild - Script install Lemp in Centos 7
# Author: Aishee Nguyen - BreakTeam
# To install type: chmod +x breakbuild.sh && ./breakbuild.sh
#######################################################
break_vers="1.0.0"
...
cat > "/etc/php.d/00-breakteam-custom.ini" <<END
...
mkdir -p /etc/breakteam/

cat > "/etc/breakteam/scripts.conf" <<END
break_vers="$break_vers"
server_name="$server_name"
server_ip="$server_ip"
...
BreakBuild Script Admin:	http://$server_name:$admin_port/ or http://$server_ip:$admin_port/
...
Support team: https://breakteam.co
END

chmod 600 /root/breakteam.txt
...
if [ "$1" = "wordpress" ]; then
	...
	printf "=========================================================================\n"
	printf "Scripts BreakBuild install complete.. \n"
	printf "=========================================================================\n"
...
printf "=========================================================================\n"
printf "BreakBuild Script Admin: http://$server_name:$admin_port/ \n or http://$server_ip:$admin_port/\n\n"
